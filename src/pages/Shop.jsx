  ...
  return (<>
    ...
    <div className='flex gap-20 mx-20 mt-20 '>
      ...
      <div className='text-2xl space-x-10'>
        <input onChange={() => setCategory("")} className='scale-150' type="radio" name='product' /> All
        <input onChange={() => setCategory("electronics")} className='scale-150' type="radio" name='product' /> electronics
        <input onChange={() => setCategory("jewelery")} className='scale-150' type="radio" name='product' /> jewelery
        <input onChange={() => setCategory("men's clothing")} className='scale-150' type="radio" name='product' /> men's clothing
        <input onChange={() => setCategory("women's clothing")} className='scale-150' type="radio" name='product' /> women's clothing
      </div>
    </div>
    <div className='flex flex-wrap justify-center gap-10 mt-20 mb-20'>
      {
        filterXog.length > 0 ? filterXog.map((item) => {
          ...
          :
          <p className='text-3xl font-bold'> There no Product</p>
      }
    </div>
  </>
  )
